...
function addSkill(skillName, skillLevel, targetId) {
    let target = get(targetId);
    let skill = `<div class="skill">
                            <h4 class="name">${skillName}</h4>
                            <div class="lvls">
                                <div class="lvl">
                                    <span class="${skillLevel === "25%" ? "percent-75" : "percent-100"}"></span>
                                </div>
                                <div class="lvl">
                                    <span class="${skillLevel === "50%" ? "percent-75" :
        skillLevel === "75%" ? "percent-100" :
            skillLevel === "100%" ? "percent-100" : ""}"></span>
                                </div>
                                <div class="lvl">
                                    <span class="${skillLevel === "100%" ? "percent-100" :
        skillLevel === "75%" ? "percent-75" : ""}"></span>
                                </div>
                            </div>
                        </div>`;
    if (target) {
...
function setText(target, text, lang) {
    let value;
    if (lang === "PT-BR") {
        value = text.ptBR;
    }
